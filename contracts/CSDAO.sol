...
contract DAOInterface {
    ...
    function numberOfProposals() returns (uint _numberOfProposals);
...
*/
    ...
    function actualBalance() public returns (uint _actualBalance) {
    ...
    function numberOfProposals() public returns (uint _numberOfProposals) {
